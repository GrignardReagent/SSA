...
# Job name
#$ -N IY023_simclr_training_joint_norm
#$ -o IY023_simclr_training_joint_norm.o$JOB_ID
#$ -e IY023_simclr_training_joint_norm.e$JOB_ID
...
python IY023_simclr_training_joint_norm.py > IY023_simclr_training_joint_norm.out 2>&1
