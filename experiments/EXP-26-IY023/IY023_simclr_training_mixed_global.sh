...
# Job name
#$ -N IY023_simclr_training_mixed_global
#$ -o IY023_simclr_training_mixed_global.o$JOB_ID
#$ -e IY023_simclr_training_mixed_global.e$JOB_ID
...
python IY023_simclr_training_mixed_global.py > IY023_simclr_training_mixed_global.out 2>&1
