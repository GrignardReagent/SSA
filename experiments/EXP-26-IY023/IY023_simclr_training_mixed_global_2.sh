...
# Job name
#$ -N IY023_simclr_training_mixed_global_2
#$ -o IY023_simclr_training_mixed_global_2.o$JOB_ID
#$ -e IY023_simclr_training_mixed_global_2.e$JOB_ID
...
python IY023_simclr_training_mixed_global_2.py > IY023_simclr_training_mixed_global_2.out 2>&1
