...
# Job name
#$ -N IY023_simclr_training_mixed_longepoch
#$ -o IY023_simclr_training_mixed_longepoch.o$JOB_ID
#$ -e IY023_simclr_training_mixed_longepoch.e$JOB_ID
...
python IY023_simclr_training_mixed_longepochs.py > IY023_simclr_training_mixed_longepochs.out 2>&1
