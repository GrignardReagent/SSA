...
# Job name
#$ -N IY023_simclr_training_mixed
#$ -o IY023_simclr_training_mixed.o$JOB_ID
#$ -e IY023_simclr_training_mixed.e$JOB_ID
...
python IY023_simclr_training_mixed.py > IY023_simclr_training_mixed.out 2>&1
