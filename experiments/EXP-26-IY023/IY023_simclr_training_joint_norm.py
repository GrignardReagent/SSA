...
# Setup Configuration
DATA_ROOT = Path("/home/s1732775/scratch_s1732775/SSA/experiments/EXP-26-IY020/data_mu_variation")
...
save_path = f'IY023_simCLR_b{batch_size}_lr{lr}_L{num_layers}_H{nhead}_D{d_model}_{timestamp}_model.pth'
