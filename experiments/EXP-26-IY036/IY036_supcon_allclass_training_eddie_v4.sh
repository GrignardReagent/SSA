...
# Job name
#$ -N IY036_supcon_allclass_training_eddie_v4
#$ -o IY036_supcon_allclass_training_eddie_v4.o$JOB_ID
#$ -e IY036_supcon_allclass_training_eddie_v4.e$JOB_ID
...
python IY036_supcon_allclass_training_eddie_v4.py > "IY036_supcon_allclass_training_eddie_v4_${RUN_TIMESTAMP}.out" 2>&1
