...
# Setup Configuration
EXP_ROOT = Path("/home/s1732775/eddie_swain/SSA/experiments/EXP-26-IY020")
...
save_path = f'IY024_simCLR_mixed_cross_view_b{batch_size}_lr{lr}_L{num_layers}_H{nhead}_D{d_model}_{normalisation}_{timestamp}_model.pth'

# === wandb config ===
wandb_config = {
    "entity": "grignard-reagent",
    "project": "IY024-SSL-model",
    "name": f"simCLR_mixed_cross_view_b{batch_size}_lr{lr}_d{dropout}_L{num_layers}_H{nhead}_D{d_model}_trj{num_traj}_len{sample_len}_{normalisation}_{timestamp}",
