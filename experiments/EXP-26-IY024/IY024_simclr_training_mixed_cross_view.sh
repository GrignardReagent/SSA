...
# Job name
#$ -N IY024_simclr_training_mixed_cross_view
#$ -o IY024_simclr_training_mixed_cross_view.o$JOB_ID
#$ -e IY024_simclr_training_mixed_cross_view.e$JOB_ID
...
python IY024_simclr_training_mixed_cross_view.py > IY024_simclr_training_mixed_cross_view.out 2>&1
