...
l_bounds = np.array([1.0,   0.1,  5.0])     # [mu_min, cv_min, t_ac_min]
u_bounds = np.array([10_000.0, 4.0, 120.0]) # [mu_max, cv_max, t_ac_max]
...
# Results log CSV
results_path = os.path.join(data_dir, "IY014_simulation_parameters_sobol.csv")
