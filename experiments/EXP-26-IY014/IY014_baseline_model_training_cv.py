...
'''
Train a baseline transformer model on IY014 data with varying cv parameters.
'''
...
RESULTS_PATH = DATA_ROOT / "IY014_simulation_cv_parameters_sobol.csv" #  this csv file stores all the simulation parameters used
...
num_traj=2
param_dist_threshold=2.3 # 10-fold change at leas
...
model_path = 'IY014_baseline_transformer_model_cv.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj} (cv variation)", # change this to what you want
