...
'''
Train a baseline transformer model on IY014 data with varying t_ac parameters.
'''

# Get the absolute path of the directory containing this script
script_dir = Path(__file__).resolve().parent
DATA_ROOT = script_dir / "data_t_ac_variation"
# DATA_ROOT = Path("/home/ianyang/stochastic_simulations/experiments/EXP-25-IY011/data_t_ac_variation")
RESULTS_PATH = DATA_ROOT / "IY014_simulation_t_ac_parameters_sobol.csv" #  this csv file stores all the simulation parameters used
...
num_traj=2
param_dist_threshold=2.3 # 10-fold change at least
...
# 1. Define paths
train_save_path = DATA_ROOT / "IY014_static_train.pt"
val_save_path   = DATA_ROOT / "IY014_static_val.pt"
test_save_path  = DATA_ROOT / "IY014_static_test.pt"
...
model_path = 'IY014_baseline_transformer_model_t_ac.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "project": "IY014-baseline-model",
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj} (t_ac variation)", # change this to what you want
