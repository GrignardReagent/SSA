#!/usr/bin/env python3
'''
This is designed to be an easy problem for the classifier to solve: the parameters have a 10-fold difference at least.
This serves as a sanity check for the baseline model architecture and training pipeline. 
'''
...
RESULTS_PATH = DATA_ROOT / "IY014_simulation_parameters_sobol.csv" #  this csv file stores all the simulation parameters used
...
model_path = 'IY014_baseline_transformer_model.pth'
# === Model hyperparams ===
