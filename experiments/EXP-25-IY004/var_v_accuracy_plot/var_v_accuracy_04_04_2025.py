...
############# READ THIS ################
# I already ran var_v_accuracy_plot_26_03_2025.py previously, this script is only for running extra classifier LSTM benchmarking experiments 
# I saved the SSA time series in data_26_03_2025/mRNA_trajectories_variance_{int(variance_target_stress)}_{int(variance_target_normal)}/m_traj_{variance_target_stress}_{variance_target_normal}_{i}.csv 
# Previous results were saved in data_26_03_2025/accuracy_results_26_03_2025.csv
############# READ THIS ################
...
for ratio in tqdm.tqdm(variance_ratios, desc="Running Variance Ratio Simulations"):
    ...
    for i in range(num_iterations):
        ...
        if not os.path.isfile("data_26_03_2025/accuracy_results_04_04_2025.csv"):
            df_acc_results.to_csv("data_26_03_2025/accuracy_results_04_04_2025.csv", index=False)
        else:
            df_acc_results.to_csv("data_26_03_2025/accuracy_results_04_04_2025.csv", mode='a', header=False, index=False)
