#!/usr/bin/env python3
"""
Simulate a batch of Sobol sequence samples - 10k to give enough dataset for transformer training
"""
...
# Results log CSV
results_path = os.path.join(data_dir, "IY020_simulation_parameters_sobol.csv")
