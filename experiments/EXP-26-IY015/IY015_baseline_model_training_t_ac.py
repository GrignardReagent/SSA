...
# 1. Define paths
train_save_path = DATA_ROOT / "IY015_static_train_t_ac.pt"
val_save_path   = DATA_ROOT / "IY015_static_val_t_ac.pt"
test_save_path  = DATA_ROOT / "IY015_static_test_t_ac.pt"
...
model_path = 'IY015_baseline_transformer_model_t_ac_1.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj} (t_ac variation) - populated data pool", # change this to what you want
