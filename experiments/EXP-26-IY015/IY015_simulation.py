...
plt.legend()
plt.grid(True)
plt.savefig('IY014_mu_target_vs_mu_observed.png', dpi=300)
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig('IY014_cv_target_vs_cv_observed.png', dpi=300)
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig('IY014_t_ac_target_vs_t_ac_observed.png', dpi=300)
plt.show()