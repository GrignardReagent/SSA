...
'''
Train a baseline transformer model on IY011 data with varying mu parameters.
'''
...
# 1. Define paths
train_save_path = DATA_ROOT / "IY015_static_train_mu.pt"
val_save_path   = DATA_ROOT / "IY015_static_val_mu.pt"
test_save_path  = DATA_ROOT / "IY015_static_test_mu.pt"
...
model_path = 'IY015_baseline_transformer_model_mu_1.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj} (mu variation) - populated data pool", # change this to what you want
