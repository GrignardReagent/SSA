...
# 1. Define paths
train_save_path = DATA_ROOT / "IY015_static_train_cv.pt"
val_save_path   = DATA_ROOT / "IY015_static_val_cv.pt"
test_save_path  = DATA_ROOT / "IY015_static_test_cv.pt"
...
model_path = 'IY015_baseline_transformer_model_cv_1.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj} (cv variation) - populated data pool", # change this to what you want
...
acc_svm_few_shot = test_svm_few_shot(unseen_datasets, crop_len=sample_len)
...
acc = test_baseline_performance(model, unseen_datasets, scaler, crop_len=sample_len, num_traj=num_traj)