...
# Setup Configuration
DATA_ROOT = Path("/home/ianyang/SSA/experiments/EXP-26-IY020/data_t_ac_variation")
...
wandb_config = {
    ...
    "name": f"simCLR_b{batch_size}_lr{lr}_d{dropout}_L{num_layers}_H{nhead}_D{d_model}_trj{num_traj}_{timestamp} (t_ac variation)", # change this to what you want
