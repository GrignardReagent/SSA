...
model_path = 'IY011_baseline_transformer_model_7_mu.pth'
# === Model hyperparams ===
...
wandb_config = {
    ...
    "name": f"num_groups_train_{num_groups_train}_traj_{num_traj}_batch_size_{batch_size} (mu variation)", # change this to what you want
