"""
IY029 v2: Bidirectional LSTM — pairwise accuracy bar chart.
Loads IY029_lstm_pairwise_v2_results.json and saves IY029_lstm_pairwise_v2_acc.png.
Style is identical to the plot-acc cell in IY029_lstm_pairwise.ipynb.
"""
import json
import numpy as np
...
results = json.load(open(SCRIPT_DIR / 'IY029_lstm_pairwise_v2_results.json'))
...
out = SCRIPT_DIR / 'IY029_lstm_pairwise_v2_acc.png'
