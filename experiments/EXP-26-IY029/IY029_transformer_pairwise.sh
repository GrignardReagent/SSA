...
# Job name
#$ -N IY029_transformer_pairwise
#$ -o IY029_transformer_pairwise.o$JOB_ID
#$ -e IY029_transformer_pairwise.e$JOB_ID
...
python IY029_transformer_pairwise.py > IY029_transformer_pairwise.out 2>&1
