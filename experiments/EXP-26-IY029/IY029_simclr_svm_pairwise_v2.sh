...
# Job name
#$ -N IY029_simclr_svm_pairwise_v2
#$ -o IY029_simclr_svm_pairwise_v2.o$JOB_ID
#$ -e IY029_simclr_svm_pairwise_v2.e$JOB_ID
...
python IY029_simclr_svm_pairwise_v2.py > IY029_simclr_svm_pairwise_v2.out 2>&1
