...
# Job name
#$ -N IY029_synthetic_svm_pairwise
#$ -o IY029_synthetic_svm_pairwise.o$JOB_ID
#$ -e IY029_synthetic_svm_pairwise.e$JOB_ID
...
python IY029_synthetic_svm_pairwise.py > IY029_synthetic_svm_pairwise.out 2>&1
