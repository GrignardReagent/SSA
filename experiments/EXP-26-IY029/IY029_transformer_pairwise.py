...
Submit with: qsub IY029_transformer_pairwise.sh  (from the EXP-26-IY029 dir)

Trains a TransformerClassifier from scratch on the IY011/IY014 pairwise
same/different task across four datasets × two fold magnitudes (8 runs total).
...
Saves:
  IY029_transformer_pairwise_results.json
  IY029_transformer_pairwise_loss.png
"""
import os
...
def main():
    ...
    # ── Save JSON ──────────────────────────────────────────────────────────────
    save_path = SCRIPT_DIR / 'IY029_transformer_pairwise_results.json'
    ...
    # ── Loss plot ──────────────────────────────────────────────────────────────
    plot_loss_curves(loss_curves, SCRIPT_DIR / 'IY029_transformer_pairwise_loss.png')
