...
Submit with: qsub IY029_lstm_pairwise.sh  (from the EXP-26-IY029 dir)

Trains a bidirectional LSTMClassifier from scratch on the IY011/IY014 pairwise
...
def main():
    ...
    # ── Save JSON ──────────────────────────────────────────────────────────────
    save_path = SCRIPT_DIR / 'IY029_lstm_pairwise_results.json'
    ...
    # ── Loss plot ──────────────────────────────────────────────────────────────
    plot_loss_curves(loss_curves, SCRIPT_DIR / 'IY029_lstm_pairwise_loss.png')
