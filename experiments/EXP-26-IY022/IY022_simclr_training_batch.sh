...
# Job name
#$ -N IY022_simclr_training_batch
#$ -o IY022_simclr_training_batch.o$JOB_ID
#$ -e IY022_simclr_training_batch.e$JOB_ID
...
python IY022_simclr_training_batch.py > IY022_simclr_training_batch.out 2>&1
