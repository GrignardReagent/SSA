...
# Setup Configuration
DATA_ROOT = Path(__file__).resolve().parent.parent / "EXP-26-IY020" / "data"
...
save_path = f'IY022_simCLR_b{batch_size}_lr{lr}_L{num_layers}_H{nhead}_D{d_model}_{normalisation}_{timestamp}_model.pth'
...
wandb_config = {
    ...
    "project": "IY022-SSL-model",
    "name": f"simCLR_b{batch_size}_lr{lr}_d{dropout}_L{num_layers}_H{nhead}_D{d_model}_trj{num_traj}_len{sample_len}_{normalisation}_{timestamp}", # change this to what you want
