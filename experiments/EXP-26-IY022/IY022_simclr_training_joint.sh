...
# Job name
#$ -N IY022_simclr_training_joint
#$ -o IY022_simclr_training_joint.o$JOB_ID
#$ -e IY022_simclr_training_joint.e$JOB_ID
...
python IY022_simclr_training_joint.py > IY022_simclr_training_joint.out 2>&1
