...
# Job name
#$ -N IY022_simclr_training_batch_2
#$ -o IY022_simclr_training_batch_2.o$JOB_ID
#$ -e IY022_simclr_training_batch_2.e$JOB_ID
...
python IY022_simclr_training_batch_2.py > IY022_simclr_training_batch_2.out 2>&1
