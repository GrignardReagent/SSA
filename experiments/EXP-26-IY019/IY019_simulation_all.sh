...
nohup python IY019_simulation.py > IY019_simulation.out 2>&1
...
nohup python IY019_simulation_mu.py > IY019_simulation_mu.out 2>&1
...
nohup python IY019_simulation_cv.py > IY019_simulation_cv.out 2>&1
...
nohup python IY019_simulation_t_ac.py > IY019_simulation_t_ac.out 2>&1
