...
############# READ THIS ################
# var_v_accuracy_13_04_2025.py encountered issues with finding parameters for variance_ratios: 
#   Index 1, Ratio = 2.8600
#   Index 3, Ratio = 2.9000
# Reruning these ratio simulations.
# Added a retry loop to find_parameters to handle cases where the function fails to find a solution.
############# READ THIS ################
...
###############################################################################
failed_ratios = []
for idx, ratio in enumerate(tqdm.tqdm(variance_ratios, desc="Running Variance Ratio Simulations")):
    ...
    for i in range(num_iterations):
        ...
        if not os.path.isfile("data_12_04_2025/accuracy_results_13_04_2025_4.csv"):
            df_acc_results.to_csv("data_12_04_2025/accuracy_results_13_04_2025_4.csv", index=False)
        else:
            df_acc_results.to_csv("data_12_04_2025/accuracy_results_13_04_2025_4.csv", mode='a', header=False, index=False)
