...
for ratio in tqdm.tqdm(variance_ratios, desc="Running Classifier Benchmarks"):
    ...
    for i in range(num_iterations):
        ...
        if not os.path.isfile("data/accuracy_results_06_03_2025.csv"):
            df_acc_results.to_csv("data/accuracy_results_06_03_2025.csv", index=False)
        else:
            df_acc_results.to_csv("data/accuracy_results_06_03_2025.csv", mode='a', header=False, index=False)
