...
variance_ratios = [2.80, 2.86, 2.88, 2.90]
autocorr_target = 0.5
...
for idx, ratio in enumerate(tqdm.tqdm(variance_ratios, desc="Running Variance Ratio Simulations")):
    ...
    for i in range(num_iterations):
        ...
        if not os.path.isfile("data_12_04_2025/accuracy_results_13_04_2025_3.csv"):
            df_acc_results.to_csv("data_12_04_2025/accuracy_results_13_04_2025_3.csv", index=False)
        else:
            df_acc_results.to_csv("data_12_04_2025/accuracy_results_13_04_2025_3.csv", mode='a', header=False, index=False)
