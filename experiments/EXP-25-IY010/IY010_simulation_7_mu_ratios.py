...
is that the target mean ``mu`` varies over ratios from 1.0 to 2.0 (with 0.1 intervals)
...
- ``mu`` varies as ``MU_FIXED * ratio`` where ratio ∈ [1.0, 1.1, ..., 2.0]
...
MU_RATIOS = np.arange(1.0, 2.1, 0.1)  # ratios from 1.0 to 2.0 with 0.1 intervals
