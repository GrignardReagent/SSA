#!/usr/bin/env python3
"""
Simulate a mini batch of the same Sobol sequence like IY010_simulation_6.py

- Use a Sobol sequence, 48 statistical properties
...
data_dir = "data_6_mini" # different folder to the first attempt.
...
U = sobol.random_base2(int(np.ceil(np.log2(N))))  # N points in [0,1)^3
...
for combination_idx, (mu, t_ac, cv) in enumerate(
    ...
    results_path = os.path.join(data_dir, "IY010_simulation_parameters_6_mini.csv")
