...
cv_target = qmc.scale(U[:, 1:2], [0.5], [2.0]).flatten()
...
for combination_idx, (mu, t_ac, cv) in enumerate(
    ...
    results_path = os.path.join(data_dir, "IY010_simulation_parameters_7_mu_t_ac_fixed.csv")
