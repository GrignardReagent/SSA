...
CV target is set to 0.5 to 2.0
"""
...
data_dir = "data_5" # different folder to the first attempt.
...
for combination_idx, (mu, t_ac, cv) in enumerate(
    ...
    results_path = os.path.join(data_dir, "IY010_simulation_parameters_5.csv")
