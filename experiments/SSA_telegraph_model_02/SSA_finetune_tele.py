...
sigma_u = [1,10,20]   # Rate of G -> G* (deactivation)
sigma_b = [0.001,0.01,0.1]    # Rate of G* -> G (activation)
rho = [100, 200]         # Rate of G -> G + M (mRNA production)
...
filtered_param_grid = [
    ...
    if r >= 10 * s_u and s_u > 100 * s_b  # Enforce rho >> sigma_u >>> sigma_b
]

# print out available parameters
print(f"Number of parameters: {len(filtered_param_grid)}")

# CSV File Path
output_file = "data/SSA_finetune_results_02.csv"
