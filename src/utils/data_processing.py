...
def add_nearest_neighbour_labels(
    ...
    *,
    ...
    ...     'autocorr_target': [5, 5, 5, 5],
    ... })
    >>> add_nearest_neighbour_labels(df)
       mu_target  cv_target  autocorr_target  label
    0        1.0       0.10               5      0
    1        1.2       0.15               5      1
    2        0.8       0.12               5      0
    3        1.1       0.14               5      1
    ...
    ``(mu_target, cv_target, autocorr_target)`` space.  Within each pair the
